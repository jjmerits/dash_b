...
performance = { "Name": ["Nikkei225"], "Return":[test_df['NKY_Cumulative_Return'].iloc[-1,]], "std":[test_df['NKY_Daily(%)'].std()], "Port Return":[test_df['JPN_Cum_Return(%)'].iloc[-1,]],"Port std":[test_df['JPN_Cum_Return(%)'].std()]
              }
